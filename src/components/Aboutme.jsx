  ...
  return (
    ...
    >
      ...
      <div
        ...
        variants={fadeUp}
      >
        <h1 className="text-white text-2xl mb-4 font-bold" variants={fadeUp}>
          About Me
        </h1>
        <p className="text-white mb-8 text-xl" variants={fadeUp}>
        ...
        <div className="flex items-center mb-8" variants={fadeUp}>
